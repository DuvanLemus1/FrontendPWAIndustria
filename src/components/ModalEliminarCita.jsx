...
const ModalEliminarCita = () => {

    const {modalEliminarCita, handleModalEliminarCita, eliminarCita} = usePacientes();
 
    return (
        <Transition.Root show={modalEliminarCita} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalEliminarCita }>
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    ...
                                    onClick={ handleModalEliminarCita }
                                >
