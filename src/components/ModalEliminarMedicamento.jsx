...
const ModalEliminarMedicamento = () => {
    ...
    const {modalEliminarMedicamento, handleModalEliminarMedicamento, eliminarMedicamento} = useProveedores();
 
    return (
        <Transition.Root show={modalEliminarMedicamento} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={handleModalEliminarMedicamento}>
                    ...
                    >
                            ...
                            <div className="hidden sm:block absolute top-0 right-0 pt-4 pr-4">
                                <button
                                    ...
                                    onClick={ handleModalEliminarMedicamento }
                                >
