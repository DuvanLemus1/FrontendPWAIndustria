...
const ModalCancelarSuscripcion = () => {
    ...
    const handleSubmit = async e =>{
        ...
        await submitCancelarSuscripcion(idDoctor)
    }

    
    return (
        <Transition.Root show={ modalCancelarSuscripcion } as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={ handleModalCancelarSuscripcion}>
